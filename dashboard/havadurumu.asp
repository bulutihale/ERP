				...
				Response.Write "<div class=""card-header text-white bg-dark"">"
                    Response.Write "<div class=""row"">"
                        ...
                        Response.Write "<div class=""col-lg-6 col-sm-6 my-1 text-right"">"
                            Response.Write "<a style=""border:1px solid white"" class=""text-small parmak ml-2 p-1"" onClick=""$('.dashhavaDurumuDiv').load('/dashboard/havadurumu.asp?tgun=0');"">" & translate("Anlık","","") & "</a>"
                            Response.Write "<a style=""border:1px solid white"" class=""text-small parmak ml-2 p-1"" onClick=""$('.dashhavaDurumuDiv').load('/dashboard/havadurumu.asp?tgun=1');"">" & translate("Yarın","","") & "</a>"
                        Response.Write "</div>"
                    Response.Write "</div>"
                Response.Write "</div>"
                Response.Write "</div>"
                    ...
                    Response.Write """>"
						Response.Write "<div class=""row mt-5 mb-5 pl-3"">"
							...
							Response.Write "<div class=""col-lg-6 col-xs-6"">"
								Response.Write translate("En Yüksek","","") & " : " & havadurumumax & "℃<br />"
								Response.Write translate("En Düşük","","") & " : " & havadurumumin & "℃<br />"
								Response.Write translate("Gece","","") & " : " & havadurumugece & "℃<br />"
								Response.Write translate("Nem","","") & " : " & havadurumunem & "<br />"
							Response.Write "</div>"
							'bugün
                        Response.Write "</div>"
                    Response.Write "</div>"
