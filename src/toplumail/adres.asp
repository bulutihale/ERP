...
call logla("Toplu Mail Adres Grubu Listesi Ekranı")
		...
		Response.Write "<div class=""row"">"
			Response.Write "<div class=""col-md-12 grid-margin stretch-card"">"
                ...
                Response.Write "<div class=""card-body"">"
					Response.Write "<form action=""/toplumail/adres.asp"" method=""post"" class=""ortaform"">"
						Response.Write "<div class=""form-row align-items-center"">"
							Response.Write "<div class=""col-lg-2 col-sm-2 my-1"">"
								Response.Write "<input type=""text"" class=""form-control"" placeholder=""Grup adı"" name=""aramaad"" value=""" & aramaad & """>"
							Response.Write "</div>"
							...
							if yetkiTM >= 3 then
								Response.Write "<div class=""col-lg-9 col-sm-3 my-1 text-right"">"
									Response.Write "<button type=""button"" class=""btn btn-success"" onClick=""modalajax('/toplumail/adres_yeni.asp')"">Yeni Adres Grubu Ekle</button>&nbsp;" 
								Response.Write "</div>"
							end if
						Response.Write "</div>"
					Response.Write "</form>"
