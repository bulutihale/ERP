				...
				Response.Write "<div class=""card-body"" style=""max-height:300px;overflow:auto;padding:0 !important"">"
                    ...
                    Response.Write """>"
                        Response.Write "<div class=""row"">"
                            ...
                            Response.Write "<tr><td>&nbsp;</td><td><button type=""submit"" class=""btn btn-info"" name=""islem"" value=""custom"">Özel Kur Güncelle</button>&nbsp;<button type=""submit"" class=""btn btn-danger"" name=""islem"" value=""tcmb"">TCMB'den Çek</button></td></tr>"
