...
'####### SONUÇ TABLOSU
    ...
    rs.close
        ...
        Response.Write "<form action=""/portal/doviz_update.asp"" class=""ajaxform"">"
		Response.Write "<div class=""row"">"
			Response.Write "<div class=""col-lg-12 col-md-12 col-sm-12 col-xs-12"">"
				Response.Write "<div class=""card"">"
				Response.Write "<div class=""card-header text-white bg-dark""><a href=""/portal/doviz"" style=""color:white"">Döviz Kurları</a></div>"
				Response.Write "<div class=""card-body"" style=""max-height:300px;overflow:auto;padding:0 !important"">"
                    ...
                    Response.Write """>"
                        Response.Write "<div class=""row"">"
                            ...
                            Response.Write "<tr><td>&nbsp;</td><td><button type=""submit"" class=""btn btn-info"" name=""islem"" value=""custom"">Özel Kur Güncelle</button>&nbsp;<button type=""submit"" class=""btn btn-danger"" name=""islem"" value=""tcmb"">TCMB'den Çek</button>"
                            Response.Write "&nbsp;<button type=""button"" class=""btn btn-warning"" onClick=""modalajax('/portal/doviz_hesapla.asp');"">Hesapla</button>"
