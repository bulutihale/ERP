...
call logla("Satınalma Talep Oluşturma Ekranı")
			...
			Response.Write "<div class=""col-md-12 grid-margin stretch-card"">"
                Response.Write "<div class=""card"">"
					Response.Write "<div class=""card-header"">"
						Response.Write "<div class=""col-12 h4 text-left"">Satın Alma Talebi Oluşturma</div>"
					Response.Write "</div>"
					Response.Write "<form action=""/satinAlmaTalep/talep_kalem_ekle.asp"" method=""post"" id=""siparisform"">"
				...
				'//NOTE - anaBirimKontrol kod örneği 
										...
										call formhidden("cariSec",0,"","cariSec","cariSec","","cariSec","")
									Response.Write "</div>"
...
Response.Write "$('#siparislistesi').load('/satinalmaTalep/talep_kalem_ekle.asp?islem=kontrol&siphash=0');"
