...
'//FIXME - aktarım yapılacak olan depoKategori sorguya manuel yazıldı dinamikleştirilmesi gerekir.
				...
				if stokID <> "" then
					...
					sorgu = sorgu & " WHERE t1.firmaID = " & firmaID & " AND t1.stokID = " & stokID & ""
					'sorgu = sorgu & " AND t2.silindi = 0 AND t2.depoKategori IN ('malKabul','uretim','kesim','fason','sterilizasyonC')"
