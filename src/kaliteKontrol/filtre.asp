...
'####### SONUÇ TABLOSU
	...
	Response.Write "<div class=""card rounded-top"">"
		...
		Response.Write "<div class=""card-body"">"
			Response.Write "<form action=""/kaliteKontrol/form_arsiv.asp"" method=""post"" id=""filtreForm"">"
			Response.Write "<div class=""row"">"
				Response.Write "<div class=""col-6"">"
					Response.Write "<div class=""badge badge-secondary rounded-left"">LOT</div>"
					call forminput("lot","","","LOT No","","autocompleteOFF","lot","")
				Response.Write "</div>"
			Response.Write "</div>"
			Response.Write "<div class=""row"">"
