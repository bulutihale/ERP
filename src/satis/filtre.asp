...
'####### SONUÇ TABLOSU
	...
	Response.Write "<div class=""card rounded-top"">"
		...
		Response.Write "<div class=""card-body"">"
			Response.Write "<form action=""/satis/siparis_liste.asp"" method=""post"" id=""filtreForm"">"
			...
			Response.Write "<div class=""row mt-2"">"
				Response.Write "<div class=""col-lg-6"">"
					Response.Write "<div class=""badge badge-secondary rounded-left"">Sipariş Tarih Aralığı</div>"
				...
				Response.Write "<div class=""col-lg-6"">"
					Response.Write "<div class=""badge badge-secondary rounded-left"">Teslim Tarih Aralığı</div>"
					Response.Write "<div class=""border border-dark rounded p-2"">"
						Response.Write "<div class=""col-lg-12"">"
							Response.Write "<div class=""badge badge-secondary rounded-left"">İlk Tarih</div>"
