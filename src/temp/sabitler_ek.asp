...
if firmaID = 1 then
	...
	'#### MODULLER
	'#### PERSONEL YETKİLER
		sb_modul="Admin,Cari,Depo,Gelişmiş Teklif,Görev Takip,Kalite Kontrol,Kesimhane,Lojistik,Mal Kabul,Personel,Planlama,Raporlar,Reçete,Satın Alma,Satış,Sterilizasyon,Stok,Teklif,Toplu Mail,Üretim,ÜTS,Yardım"
