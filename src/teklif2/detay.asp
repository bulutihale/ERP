	...
	Response.Write "<div id=""urunlerInput"" class=""border border-dark"">"
		...
		Response.Write "<div class=""row"">"
			...
			if ihaleTipi = "proforma" then
				...
				call formselectv2("urunSec","","","","formSelect2 urunSec border","","urunSec","","data-holderyazi=""Stok Adı"" data-sart="""&stokSart&""" data-sartozel=""LEFT(t1.stokKodu,1)='M'"" data-jsondosya=""JSON_stoklar"" data-miniput=""3"" onchange=""stokRefCagir('" & cariID & "',$(this).val())""")
			Response.Write "</div>"
			Response.Write "<div class=""col-lg-5"">"
