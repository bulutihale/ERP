					...
					Response.Write "<div class=""card-body"">"
						Response.Write "<div class=""row"">"
							...
							Response.Write "<div class=""col-6"">"
								...
								call formselectv2("cariSec","","$('#divStokRef').load('/stok/stok_ref_liste.asp',{stokID:$('#stokSec').val(), cariID:$(this).val()});","","formSelect2 cariSec border","","cariSec","","data-holderyazi=""Cari adı, cari kodu, vergi no"" data-jsondosya=""JSON_cariler""")
							Response.Write "</div>"
						Response.Write "</div>"
						Response.Write "<div class=""row"">"
							Response.Write "<div class=""col-6"">"
